# Generated by Powerlevel10k configuration wizard on 2020-03-02 at 17:23 CET.
...
# time, slanted separators, slanted heads, flat tails, 2 lines, disconnected, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=#2C323C
