# Generated by Powerlevel10k configuration wizard on 2020-04-16 at 00:46 CEST.
...
is_inside_docker() { if [ -f /.dockerenv ]; then echo 'dev'; fi }
...
() {
  ...
  typeset -g POWERLEVEL9K_CUSTOM_DEV='is_inside_docker'
  typeset -g POWERLEVEL9K_CUSTOM_DEV_FOREGROUND=180

  # The list of segments shown on the left. Fill it with the most important segments.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    custom_dev              # is inside dev-container
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND='#FF5C57'
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='✘'

  # Status when the last command was terminated by a signal.
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND='#FF5C57'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND='#FF5C57'
